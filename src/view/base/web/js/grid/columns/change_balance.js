define([
    ...
    'jquery',
    'mage/template',
    'text!Praxigento_Accounting/templates/grid/cells/change_balance.html',
    ...
    return Column.extend({
        ...
        getAccountId: function (row) {
            return row[this.index + '_accountId'];
        },
        ...
        preview: function (row) {
            var modalHtml = mageTemplate(
                sendmailPreviewTemplate,
                {
                    ...
                    accountId: this.getAccountId(row),
