    ...
    extends \Praxigento\Core\Test\BaseCase\Service\Call
{
    ...
    protected function setUp()
    {
        ...
        $this->mRepoBalance = $this->_mock(\Praxigento\Accounting\Repo\Entity\Balance::class);
        $this->mRepoOperation = $this->_mock(\Praxigento\Accounting\Repo\Entity\Operation::class);
        $this->mRepoTransaction = $this->_mock(\Praxigento\Accounting\Repo\Entity\Transaction::class);
        $this->mRepoTypeAsset = $this->_mock(\Praxigento\Accounting\Repo\Entity\Type\Asset::class);
        $this->mRepoTypeOper = $this->_mock(\Praxigento\Accounting\Repo\Entity\Type\Operation::class);
        $this->mRepoLogChangeAdmin = $this->_mock(\Praxigento\Accounting\Repo\Entity\Log\Change\Admin::class);
